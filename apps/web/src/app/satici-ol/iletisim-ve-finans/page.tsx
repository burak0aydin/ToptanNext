            ...
            <div className='mt-8 pt-6 border-t border-slate-200'>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <p className='text-xs text-slate-600 leading-relaxed'>
                    Başvurunuz admin ekibi tarafından kontrol edilip onaya alınacaktır.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className='min-w-0 flex-1'>
          ...
          <form className='space-y-6' onSubmit={handleSubmit(onSubmit)}>
            <div className='bg-surface-container-lowest rounded-xl p-8 border border-outline-variant/30 shadow-sm'>
              <h2 className='text-lg font-bold mb-5'>Şirket Finans Bilgileri</h2>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6'>
                <div>
                  ...
                  />
                  {errors.companyIban ? (
                    <p className='mt-1 text-xs text-red-600'>{errors.companyIban.message}</p>
                  ) : null}
                </div>
                ...
                <div>
                  ...
                  />
                  {errors.kepAddress ? (
                    <p className='mt-1 text-xs text-red-600'>{errors.kepAddress.message}</p>
                  ) : null}
                </div>
                ...
                <div className='rounded-lg border border-slate-300 bg-white p-4 shadow-sm'>
                  <label className='inline-flex items-center gap-2 text-sm font-medium text-slate-700'>
                    <input
                      ...
                      onChange={(event) =>
                        setValue('warehouseSameAsHeadquarters', event.target.checked, {
                          shouldDirty: true,
                          shouldTouch: true,
                          shouldValidate: true,
                        })
                    ...
                    />
                    Sevkiyat / İade Depo Adresi, şirket merkezi adresi ile aynıdır.
                  </label>
                </div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6'>
                <div>
                  ...
                  {errors.contactFirstName ? (
                    <p className='mt-1 text-xs text-red-600'>{errors.contactFirstName.message}</p>
                  ) : null}
                </div>
                ...
                <div>
                  ...
                  {errors.contactLastName ? (
                    <p className='mt-1 text-xs text-red-600'>{errors.contactLastName.message}</p>
                  ) : null}
                </div>
            ...
            <div className='rounded-xl border border-primary/10 bg-primary/5 p-4 flex gap-3'>
              ...
              <p className='text-sm text-slate-600 leading-relaxed'>
                Bu adımda girilen bilgiler, sözleşme ve ödeme süreçlerinde kullanılacaktır.
                Lütfen kurumunuzla uyumlu ve güncel bilgi giriniz.
              </p>
            </div>
            ...
            <div className='pt-2 flex flex-col-reverse sm:flex-row sm:justify-between gap-3'>
              ...
              >
                {upsertMutation.isPending ? 'Kaydediliyor...' : 'Kaydet ve Devam Et'}
