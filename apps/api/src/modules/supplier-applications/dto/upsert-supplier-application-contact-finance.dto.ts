...
export class UpsertSupplierApplicationContactFinanceDto {
  ...
  @IsBoolean({ message: 'Merkez adresiyle aynı bilgisi zorunludur.' })
  warehouseSameAsHeadquarters!: boolean;

  @IsString({ message: 'Sevkiyat / İade Depo Adresi metin olmalıdır.' })
  @MaxLength(500, {
    message: 'Sevkiyat / İade Depo Adresi en fazla 500 karakter olabilir.',
  })
